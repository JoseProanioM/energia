...
def load_data():
    ...
    data = pd.read_csv("C:/Users/josep.JOSE/OneDrive/Documents/3. Work/Oikonomics/17. OikoData/Do-Files y Scripts/streamlit_app_energía/data/predicción_energía.csv", parse_dates=["Periodo"])
    return data
